document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Add menu buttons dynamically based on authentication status
    const buttons = [
    ...
    if (isLoggedIn) {
        ...
        buttons.push(
            { text: 'Iniciar sesión', id: 'signin-btn', href: 'signin.html' }
        );
    }
        ...
        try {
            ...
            events.forEach(event => {
                ...
                eventCard.innerHTML = `
                    ...
                    <div class="details">
                        <h3>
                            <a href="profile-public.html?id=${event.artist_id}" class="artist-link">
                            ${event.artist_name}
                        </a>
                        </h3>
                ...
                eventCard.addEventListener('click', () => {
                    ...
                    console.log('Artist ID:', event.artist_id);
                });
